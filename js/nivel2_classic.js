...
function main() {
    console.log(122);
    var canvas = document.getElementById("level2_classico");
    ...
    function imgLoadedHandler(ev)
    {
        ...
        switch(img.id){
            case "carroestacionado1":
                var sp1 = new CarroEstacionado(60, 8,50,100, img);
                var sp2 =new CarroEstacionado(365, 8,50,100,img);
                var sp3 =new CarroEstacionado(415, 295,50,100,img);
                spriteArray[0] = sp1;
                spriteArray[1] = sp2;
                spriteArray[2] = sp3;
                break;
            case "carroestacionado2":
                var sp4 =new CarroEstacionado(340, 295,50,100,img);
                var sp5 =new CarroEstacionado(620, 295,50,100,img);
            ...
            case "player1":
                ...
                break;
            case "areaest":
                var area = new CarroEstacionado(264,286,60,110,img);
                sArray[1]=area;
                break;
        }
        nLoad++;
