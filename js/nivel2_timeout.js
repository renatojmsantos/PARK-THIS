...
function main() {
    console.log(122);
    var canvas = document.getElementById("level2_timeout");
...
count=200;
var aux1= window.localStorage.getItem("count");
if(aux1=="1")count=250;
if(aux1=="2")count=180;
if(aux1=="3")count=120;
//var count=120;
function start(){
    if((count -1) >=0){
        ...
        document.getElementById("tempo").innerHTML = count +  "s ";
    ...
    function imgLoadedHandler(ev)
    {
        ...
        switch(img.id){
            case "carroestacionado1":
                var sp1 = new CarroEstacionado(60, 4,50,100, img);
                var sp2 =new CarroEstacionado(365, 4,50,100,img);
                var sp3 =new CarroEstacionado(415, 300,50,100,img);
                spriteArray[0] = sp1;
                spriteArray[1] = sp2;
                spriteArray[2] = sp3;
                break;
            case "carroestacionado2":
                var sp4 =new CarroEstacionado(340, 300,50,100,img);
                var sp5 =new CarroEstacionado(620, 300,50,100,img);
                ...
                break;
            case "player1":
                var splayer = new CarroPlayer(660,296,100,100,img);
                sArray[0]=splayer;
                console.log(sArray[0]);
                break;
            case "areaest":
                var area = new CarroEstacionado(264,290,60,110,img);//Talvez criar AreaEst class
                sArray[1]=area;
                break;
        }
        nLoad++;
...
function mensMapCompleted(ctx,ch,cw){
    ...
    ctx.font = "50px Arial";
    ctx.fillStyle = "#cc0099";
    ctx.fillText("Map Completed", 210, ch/2-15);
