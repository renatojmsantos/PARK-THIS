...
function main() {
    var canvas = document.getElementById("level1_timeout");
...
count = 200;
aux1= window.localStorage.getItem("count");
    ...
    function imgLoadedHandler(ev)
    {
        ...
        switch(img.id){
            case "carroestacionado1":
                var sp1 = new CarroEstacionado(95, 90,50,100, img);
                var sp2 =new CarroEstacionado(370, 90,50,100,img);
                var sp3 =new CarroEstacionado(370, 210,50,100,img);
                spriteArray[0] = sp1;
                spriteArray[1] = sp2;
                spriteArray[2] = sp3;
                break;
            case "carroestacionado2":
                var sp4 =new CarroEstacionado(300, 210,50,100,img);
                var sp5 =new CarroEstacionado(615, 210,50,100,img);
                ...
                break;
            case "player1":
                var splayer = new CarroPlayer(180,280,100,100,img);
                sArray[0]=splayer;
                console.log(sArray[0]);
                break;
            case "areaest":
                var area = new CarroEstacionado(92,205,60,110,img);
                sArray[1]=area;
                break;
        }
        nLoad++;
